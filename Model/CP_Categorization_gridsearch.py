...
dfmetrics.to_excel(r"filepath\metricsbygridsearch.xlsx", index=False)
dfparams.to_excel(r"filepath\paramsbygridsearch.xlsx", index=False)
...
new_dataset = MyDataset(new_encodings, np.zeros((len(new_texts), 4))) 
...
new_data.to_excel(r"filepath\CPpredictedbygridsearch.xlsx", index=False)